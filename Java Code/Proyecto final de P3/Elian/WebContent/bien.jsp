...
<div style="position: absolute;left: 450px;top: 30px;z-index: 45">Bienvenido:</div><div style="position: absolute;left: 519px;top: 30px;z-index: 48"><%=request.getSession().getAttribute("usuario")%></div>


<div id="mensaje" style="position: absolute;left:400px;top: 350px;z-index: 34"><font color="red"><b>Mensaje:</b></font></div><div id="especifico" style="position: absolute;left: 460px;top: 350px;z-index: 36"><%=request.getSession().getAttribute("mensaje") %></div>
