...
function validar(n,t,s){
	if(n==0){
		document.getElementById('text7').innerHTML = '* Debe escoger un nombre';
		return;
	}else{
		document.getElementById('text7').innerHTML = '';
	}
	if(t==0){
		document.getElementById('text8').innerHTML = '* Debe escoger un tipo';
		return;
	}else{
		document.getElementById('text8').innerHTML = '';
	}
	if(s.length != 11){
		document.getElementById('ultimo').innerHTML = '* Deben ser 11 caracteres';
		return;
	}else{
		document.getElementById('ultimo').innerHTML = '';
	}
	document.adicionarArma.submit();	
}
...
<body link="#606060" vlink="#606060" alink="#606060" class="fondo">
...
<div id="roundrect10" style="position:absolute; overflow:hidden; left:387px; top:254px; width:235px; height:176px; z-index:19"><img border=0 width="100%" height="100%" alt="" src="images/roundrect22450046.gif"></div>
...
<div id="text6" style="position:absolute; overflow:hidden; left:424px; top:308px; width:29px; height:17px; z-index:21"><div class="wpmd">
<div>Tipo:</div>
</div></div>
<form name='adicionarArma' action="adicionarArma" method="post">
<select name="nombres" style="position:absolute;left:456px;top:270px;width:154px;z-index:22">
...
<select name="tipos" style="position:absolute;left:456px;top:305px;width:154px;z-index:23">
<option value="[........Seleccione.........]">[........Seleccione.........]</option>
<option value="Automática">Automática</option>
<option value="Manual">Manual</option>
</select>
<label style="position:absolute;left:394px;top:342px;width:154px;z-index:34">Nro serie:</label>
<input type="text" name="nroSerie" value="" style="position:absolute;left:456px;top:342px;z-index:33">
<input name="Insertar" type="button" onclick="validar(nombres.selectedIndex,tipos.selectedIndex,nroSerie.value)"  value="Insertar" style="position:absolute;left:533px;top:390px;z-index:24">
<input name="cancelar" type="reset" value="Cancelar" style="position:absolute;left:419px;top:390px;z-index:25">
</form>

<div id="ultimo" style="position:absolute; overflow:hidden; left:624px; top:342px; width:164px;color:#F00000; height:20px; z-index:35">
<div class="wpmd">
<div><font class="ws11" face="Arial"></font></div>
</div></div>

<div id="text7" style="position:absolute; overflow:hidden; left:624px; top:272px; width:164px;color:#F00000;height:20px;z-index:26">
<div class="wpmd">
<div><font class="ws11" face="Arial"></font></div>
</div></div>

<div id="text8" style="position:absolute; overflow:hidden; left:624px; top:307px; width:164px;color:#F00000; height:20px;z-index:27"><div class="wpmd">
<div><font class="ws11" face="Arial"></font></div>
</div></div>

<div id="text2" style="position:absolute; overflow:hidden; left:464px; top:223px; width:127px; height:18px; z-index:28"><div class="wpmd">
<div><font color="#808080"><B>Insertar arma</B></font></div>
</div></div>

<div id="text9" style="position:absolute; overflow:hidden; left:261px; top:183px; width:530px; height:19px; z-index:29"><div class="wpmd">
