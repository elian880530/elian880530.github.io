...
<div id='div'></div>
            ...
            try {
                ...
                rs = stm.executeQuery("SELECT * FROM registrofecha");
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            <table   style="overflow: auto;z-index: 19">
                <tr bgcolor="white">
                    ...
                    <th><b><font color="black" style="background: white"> Fecha </font></b></th>
                    <th><b><font color="black" style="background: white"> Hora </font></b></th>
                    <%
            int cont = 0;
...
<div id="links" style="position:absolute; overflow:hidden; left:261px; top:183px; width:530px; height:19px; z-index:29"><div class="wpmd">
...
<div><font color="#808080"><B>Trazas:</B></font></div>
</div></div>
