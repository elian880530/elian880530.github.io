...
<div id="error" style="position: absolute;left:300px;top: 350px;z-index: 34"><font color="red"><b>Detalles:</b></font></div><div id="especifico" style="position: absolute;left: 359px;top: 350px;z-index: 36"><%=request.getSession().getAttribute("error") %></div>
