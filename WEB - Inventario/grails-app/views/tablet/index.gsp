            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="Tablet">
                                    Nuevo
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Tablet</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main" >
                    <div class="form-inline">
                        <g:uploadForm controller="Tablet" action="uploadFile" class="form-inline">
                            <ol class="breadcrumb derecha">
                                ...
                                <li>
                                    <g:link action="downloadFile" controller="Tablet">
                ...
                <div class="col-md-12 content scaffold-show" role="main">
                    <g:if test="${flash.message == "1"}">
                        <div class="alert alert-success">
                            <strong>¡Correcto!</strong> Nuevo Tablet Importado desde el Archivo Excel.
                        </div>
                    </g:if>
                                            ...
                                            <div class="table-responsive">
                                                <div id="dataTables-example_wrapper"
                                                    ...
                                                    <table class="table-hover table table-dark table-striped dataTable no-footer table-hover"
                                                        ...
                                                        <tbody>
                                                        <g:each in="${tabletList}" var="tablet" status="i">
                                                            <tr>
                                                                <td class="sorting_1">${tablet.id}</td>
                                                                <td>${tablet.imei}</td>
                                                                <td>${tablet.cantRam}</td>
                                                                <td>${tablet.cantAlmacenamiento}</td>
                                                                <td>${tablet.numSerie}</td>
                                                                <td>${tablet.dispositivoAsignado}</td>
                                                                <td>${tablet.proveedor}</td>
                                                                <td>
                                                                    <g:formatDate format="dd-MM-yyyy" date="${tablet.fechaCompra}"/>
                                                                </td>
                                                                <td>${tablet.tipoMicro}</td>
                                                                <td>${tablet.marcaTablet}</td>
                                                                <td>
                                                                    <a href="/tablet/edit/${tablet.id}" class="edit"><i
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <g:if test="${asignado == 0}">
                                                                        <button type="button" class="eliminar"
                                                                                data-toggle="modal"
                                                                                data-target="#exampleModal${tablet.id}">
                                                                            <i class="glyphicon glyphicon-trash"></i>
                                                                        </button>
                                                                        <!-- Modal -->
                                                                        <div class="modal fade"
                                                                             id="exampleModal${tablet.id}" tabindex="-1"
                                                                             role="dialog"
                                                                             aria-labelledby="exampleModalLabel${tablet.id}"
                                                                             aria-hidden="true">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="alert alert-warning">
                                                                                            <strong>
                                                                                                ¿Está usted seguro que desea eliminar el tablet con el identificador ${tablet.id}?                                                                                           </strong>
                                                                                        </div>
                                                                                    </div>

                                                                                    <div class="modal-footer">
                                                                                        <g:form resource="${tablet}"
                                                                                                method="DELETE">
                                                                                            <button type="submit"
