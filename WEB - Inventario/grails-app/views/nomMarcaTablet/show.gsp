...
<head>
    ...
    <title>Mostrar Marcas Tablet</title>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-nomMarcaTablet" class="col-lg-12" role="main">

                                                    <div id="show-nomMarcaTablet" class="content scaffold-show"
                                                         role="main">
                                                        <div class="alert alert-success">
                                                            <strong>¡Correcto!</strong> Nueva Marca Tablet.
                                                        </div>
                                                        <g:form resource="${this.nomMarcaTablet}"
                                                                method="DELETE">
                                                            <g:link action="edit" resource="${this.nomMarcaTablet}">
                                                            ...
                                                            <g:each var="Tablet"
                                                                    ...
                                                                    status="j">
                                                                <g:if test="${Objects.equals(nomMarcaTablet.id, Tablet.marcaTablet?.id)}">
