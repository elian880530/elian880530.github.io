            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Listado <small>Ubicaciones</small>
                    </h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="NomUbicacion">
                                    Nueva
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Ubicaciones</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main" >
                    <div class="form-inline">
                        <g:uploadForm controller="NomUbicacion" action="uploadFile" class="form-inline">
                            <ol class="breadcrumb derecha">
                                ...
                                <li>
                                    <g:link action="downloadFile" controller="NomUbicacion">
                ...
                <div class="col-md-12 content scaffold-show" role="main">
                    <g:if test="${flash.message == "1"}">
                        <div class="alert alert-success">
                            <strong>¡Correcto!</strong> Nueva Ubicacion Importada desde el Archivo Excel.
                        </div>
                    </g:if>
                                            ...
                                            <div class="table-responsive">
                                                <div id="dataTables-example_wrapper"
                                                    ...
                                                    <table class="table-hover table table-dark table-striped dataTable no-footer"
                                                        ...
                                                        <tbody>
                                                        <g:each in="${nomUbicacionList}" var="ubicacion" status="i">
                                                            <tr>
                                                                <td class="sorting_1">${ubicacion.id}</td>
                                                                <td>${ubicacion.ubicacion}</td>
                                                                <td>
                                                                    <a href="/nomUbicacion/edit/${ubicacion.id}"
                                                                       class="edit"><i
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <g:each var="Linea"
                                                                            ...
                                                                            status="k">
                                                                        <g:if test="${Objects.equals(ubicacion.id, Linea.ubicacion?.id)}">
                                                                    ...
                                                                    <g:each var="Pc"
                                                                            ...
                                                                            status="l">
                                                                        <g:if test="${Objects.equals(ubicacion.id, Pc.ubicacion?.id)}">
                                                                            <g:set var="utilizado" value="${1}"/>
                                                                        </g:if>
                                                                    </g:each>
                                                                    <g:each var="Portatil"
                                                                            ...
                                                                            status="m">
                                                                        <g:if test="${Objects.equals(ubicacion.id, Portatil.ubicacion?.id)}">
                                                                            <g:set var="utilizado" value="${1}"/>
                                                                        </g:if>
                                                                    </g:each>
                                                                    <g:if test="${utilizado == 0}">
                                                                        <button type="button" class="eliminar"
                                                                                data-toggle="modal"
                                                                                data-target="#exampleModal${ubicacion.id}">
                                                                            <i class="glyphicon glyphicon-trash"></i>
                                                                        </button>
                                                                        <!-- Modal -->
                                                                        <div class="modal fade"
                                                                             id="exampleModal${ubicacion.id}" tabindex="-1"
                                                                             role="dialog"
                                                                             aria-labelledby="exampleModalLabel${ubicacion.id}"
                                                                             aria-hidden="true">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="alert alert-warning">
                                                                                            <strong>
                                                                                                ¿Está usted seguro que desea eliminar la ubicación con el identificador ${ubicacion.id}?
                                                                                            </strong>
                                                                                        </div>
                                                                                    </div>

                                                                                    <div class="modal-footer">
                                                                                        <g:form resource="${ubicacion}"
                                                                                                method="DELETE">
                                                                                            <button type="submit"
