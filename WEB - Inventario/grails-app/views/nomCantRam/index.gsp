            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Listado <small>Cantidad Ram</small>
                    </h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="NomCantRam">
                                    Nueva
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Cantidad Ram</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main" >
                    <div class="form-inline">
                        <g:uploadForm controller="NomCantRam" action="uploadFile" class="form-inline">
                            <ol class="breadcrumb derecha">
                                ...
                                <li>
                                    <g:link action="downloadFile" controller="NomCantRam">
                ...
                <div class="col-md-12 content scaffold-show" role="main">
                    <g:if test="${flash.message == "1"}">
                        <div class="alert alert-success">
                            <strong>¡Correcto!</strong> Nueva Cantidad de Ram Importada desde el Archivo Excel.
                        </div>
                    </g:if>
                                            ...
                                            <div class="table-responsive">
                                                <div id="dataTables-example_wrapper"
                                                    ...
                                                    <table class="table-hover table table-dark table-striped dataTable no-footer"
                                                        ...
                                                        <tbody>
                                                        <g:each in="${nomCantRamList}" var="cantRam" status="i">
                                                            <tr>
                                                                <td class="sorting_1">${cantRam.id}</td>
                                                                <td>${cantRam.cantRam}</td>
                                                                <td>
                                                                    <a href="/nomCantRam/edit/${cantRam.id}"
                                                                       class="edit"><i
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <g:each var="Tablet"
                                                                            ...
                                                                            status="j">
                                                                        <g:if test="${Objects.equals(cantRam.id, Tablet.cantRam?.id)}">
                                                                    ...
                                                                    <g:each var="Movil"
                                                                            ...
                                                                            status="k">
                                                                        <g:if test="${Objects.equals(cantRam.id, Movil.cantRam?.id)}">
                                                                            <g:set var="utilizado" value="${1}"/>
                                                                        </g:if>
                                                                    </g:each>
                                                                    <g:each var="Pc"
                                                                            ...
                                                                            status="l">
                                                                        <g:if test="${Objects.equals(cantRam.id, Pc.cantRam?.id)}">
                                                                            <g:set var="utilizado" value="${1}"/>
                                                                        </g:if>
                                                                    </g:each>
                                                                    <g:each var="Portatil"
                                                                            ...
                                                                            status="m">
                                                                        <g:if test="${Objects.equals(cantRam.id, Portatil.cantRam?.id)}">
                                                                            <g:set var="utilizado" value="${1}"/>
                                                                        </g:if>
                                                                    </g:each>
                                                                    <g:if test="${utilizado == 0}">
                                                                        <button type="button" class="eliminar"
                                                                                data-toggle="modal"
                                                                                data-target="#exampleModal${cantRam.id}">
                                                                            <i class="glyphicon glyphicon-trash"></i>
                                                                        </button>
                                                                        <!-- Modal -->
                                                                        <div class="modal fade"
                                                                             id="exampleModal${cantRam.id}" tabindex="-1"
                                                                             role="dialog"
                                                                             aria-labelledby="exampleModalLabel${cantRam.id}"
                                                                             aria-hidden="true">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="alert alert-warning">
                                                                                            <strong>
                                                                                                ¿Está usted seguro que desea eliminar la cantidad de ram con el identificador ${cantRam.id}?
                                                                                            </strong>
                                                                                        </div>
                                                                                    </div>

                                                                                    <div class="modal-footer">
                                                                                        <g:form resource="${cantRam}"
                                                                                                method="DELETE">
                                                                                            <button type="submit"
