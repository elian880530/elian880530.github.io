                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-portatil" class="paginaform" role="main">
                                                    <form class="form-inline" role="form" action="/portatil/save"
                                                          method="post">
                                                        <div class="form-group dataselect">
                                                            <label>Fecha de Compra</label>
                                                            <g:datePicker type="date" name="fechaCompra"
                                                                          id="fechaCompra" precision="day"
                                                                          value="${portatil?.fechaCompra}"/>
                                                        </div>

                                                        <div class="form-group">
                                                            <label>Marca Portatil</label>
                                                            <select class="selectpicker form-control" name="marcaPortatil.id"
                                                                    id="marcaPortatil" data-size="5" data-live-search="true">
                                                                <g:each var="a"
