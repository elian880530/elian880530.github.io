            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Listado <small>Portátiles</small>
                    </h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="Portatil">
                                    Nuevo
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Portátiles</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main" >
                    <div class="form-inline">
                        <g:uploadForm controller="Portatil" action="uploadFile" class="form-inline">
                            <ol class="breadcrumb derecha">
                                ...
                                <li>
                                    <g:link action="downloadFile" controller="Portatil">
                ...
                <div class="col-md-12 content scaffold-show" role="main">
                    <g:if test="${flash.message == "1"}">
                        <div class="alert alert-success">
                            <strong>¡Correcto!</strong> Nuevo Portátil Importado desde el Archivo Excel.
                        </div>
                    </g:if>
                                            ...
                                            <div class="table-responsive">
                                                <div id="dataTables-example_wrapper"
                                                    ...
                                                    <table class="table-hover table table-dark table-striped dataTable no-footer"
                                                        ...
                                                        <tbody>
                                                        <g:each in="${portatilList}" var="portatil" status="i">
                                                            <tr>
                                                                <td class="sorting_1">${portatil.id}</td>
                                                                <td>${portatil.cantRam}</td>
                                                                <td>${portatil.cantAlmacenamiento}</td>
                                                                <td>${portatil.pegatina}</td>
                                                                <td>${portatil.dispositivoAsignado}</td>
                                                                <td>${portatil.proveedor}</td>
                                                                <td>
                                                                    <g:formatDate format="dd-MM-yyyy" date="${portatil.fechaCompra}"/>
                                                                </td>
                                                                <td>${portatil.ubicacion}</td>
                                                                <td>${portatil.tipoMicro}</td>
                                                                <td>${portatil.marcaPortatil}</td>
                                                                <td>
                                                                    <a href="/portatil/edit/${portatil.id}"
                                                                       class="edit"><i
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <g:if test="${asignado == 0}">
                                                                        <button type="button" class="eliminar"
                                                                                data-toggle="modal"
                                                                                data-target="#exampleModal${portatil.id}">
                                                                            <i class="glyphicon glyphicon-trash"></i>
                                                                        </button>
                                                                        <!-- Modal -->
                                                                        <div class="modal fade"
                                                                             id="exampleModal${portatil.id}" tabindex="-1"
                                                                             role="dialog"
                                                                             aria-labelledby="exampleModalLabel${portatil.id}"
                                                                             aria-hidden="true">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="alert alert-warning">
                                                                                            <strong>
                                                                                                ¿Está usted seguro que desea eliminar el portatil con el identificador ${portatil.id}?
                                                                                            </strong>
                                                                                        </div>
                                                                                    </div>

                                                                                    <div class="modal-footer">
                                                                                        <g:form resource="${portatil}"
                                                                                                method="DELETE">
                                                                                            <button type="submit"
