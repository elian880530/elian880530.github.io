            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Nueva <small>Cuenta Facturación</small>
                    </h1>
                    <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-nomCuentaFacturacion" class="col-lg-6" role="main">
                                                    <form role="form" action="/nomCuentaFacturacion/save" method="post">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" value="" required=""
                                                                   maxlength="100"
                                                                   name="cuentaFacturacion" id="cuentaFacturacion"
                                                                   type="text">
                                                        </div>
                                                        <g:link action="index" controller="NomCuentaFacturacion">
