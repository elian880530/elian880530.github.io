            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Editar <small>Cuenta Facturación</small>
                    </h1>
                    <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="edit-nomCuentaFacturacion" class="paginaform" role="main">
                                                    <g:form class="form-inline" role="form"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control"
                                                                   value="${this.nomCuentaFacturacion}" required=""
                                                                   maxlength="100" name="cuentaFacturacion"
                                                                   id="cuentaFacturacion"
                                                                   type="text">
                                                        </div>

                                                        <g:render template="/layouts/ImportacionModalAlerta"/>
                                                        <g:render template="/layouts/ImportacionValidarCambiosEditNomCuentaFacturacion"/>


                                                        <div id="paginaform">
                                                            <span class="izquierda">
                                                                <g:link action="index"
                                                                        controller="NomCuentaFacturacion">
