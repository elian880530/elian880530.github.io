            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Listado <small>Cuentas Facturación</small>
                    </h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="NomCuentaFacturacion">
                                    Nueva
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Cuentas Facturación</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main" >
                    <div class="form-inline">
                        <g:uploadForm controller="NomCuentaFacturacion" action="uploadFile" class="form-inline">
                            <ol class="breadcrumb derecha">
                                ...
                                <li>
                                    <g:link action="downloadFile" controller="NomCuentaFacturacion">
                ...
                <div class="col-md-12 content scaffold-show" role="main">
                    <g:if test="${flash.message == "1"}">
                        <div class="alert alert-success">
                            <strong>¡Correcto!</strong> Nueva Cuenta de Facturación Importada desde el Archivo Excel.
                        </div>
                    </g:if>
                                            ...
                                            <div class="table-responsive">
                                                <div id="dataTables-example_wrapper"
                                                    ...
                                                    <table class="table-hover table table-dark table-striped dataTable no-footer"
                                                        ...
                                                        <tbody>
                                                        <g:each in="${nomCuentaFacturacionList}" var="cuentaFacturacion"
                                                                status="i">
                                                            <tr>
                                                                <td class="sorting_1">${cuentaFacturacion.id}</td>
                                                                <td>${cuentaFacturacion.cuentaFacturacion}</td>
                                                                <td>
                                                                    <a href="/nomCuentaFacturacion/edit/${cuentaFacturacion.id}"
                                                                       class="edit"><i
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <g:each var="Linea"
                                                                            ...
                                                                            status="j">
                                                                        <g:if test="${Objects.equals(cuentaFacturacion.id, Linea.cuentaFacturacion?.id)}">
                                                                    ...
                                                                    <g:if test="${utilizado == 0}">
                                                                        <button type="button" class="eliminar"
                                                                                data-toggle="modal"
                                                                                data-target="#exampleModal${cuentaFacturacion.id}">
                                                                            <i class="glyphicon glyphicon-trash"></i>
                                                                        </button>
                                                                        <!-- Modal -->
                                                                        <div class="modal fade"
                                                                             id="exampleModal${cuentaFacturacion.id}" tabindex="-1"
                                                                             role="dialog"
                                                                             aria-labelledby="exampleModalLabel${cuentaFacturacion.id}"
                                                                             aria-hidden="true">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="alert alert-warning">
                                                                                            <strong>
                                                                                                ¿Está usted seguro que desea eliminar la cuenta de facturación con el identificador ${cuentaFacturacion.id}?
                                                                                            </strong>
                                                                                        </div>
                                                                                    </div>

                                                                                    <div class="modal-footer">
                                                                                        <g:form resource="${cuentaFacturacion}"
                                                                                                method="DELETE">
                                                                                            <button type="submit"
