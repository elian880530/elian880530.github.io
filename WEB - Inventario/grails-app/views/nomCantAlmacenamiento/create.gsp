                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-nomCantAlmacenamiento" class="col-lg-6" role="main">
                                                    <form role="form" action="/nomCantAlmacenamiento/save"
                                                          method="post">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" value="" required=""
                                                                   maxlength="100"
                                                                   name="cantAlmacenamiento" id="cantAlmacenamiento"
                                                                   type="text">
                                                        </div>
                                                        <g:link action="index" controller="NomCantAlmacenamiento">
