...
<head>
    ...
    <title>Editar Cant Almacenamiento</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Editar <small>Cantidad Almacenamiento</small>
                    </h1>
                    <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="edit-nomCantAlmacenamiento" class="paginaform" role="main">
                                                    <g:form class="form-inline" role="form"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control"
                                                                   value="${this.nomCantAlmacenamiento}"
                                                                   required="" maxlength="100" name="cantAlmacenamiento"
                                                                   id="cantAlmacenamiento" type="text">
                                                        </div>

                                                        <g:render template="/layouts/ImportacionModalAlerta"/>
                                                        <g:render template="/layouts/ImportacionValidarCambiosEditNomCantAlmacenamiento"/>

                                                        <div id="paginaform">
                                                            <span class="izquierda">
                                                                <g:link action="index"
                                                                        controller="NomCantAlmacenamiento">
