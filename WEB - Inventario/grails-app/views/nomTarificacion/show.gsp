...
<head>
    ...
    <title>Mostrar Tarificación</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Nueva <small>Tarificación</small>
                    </h1>
                    <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-nomTarificacion" class="col-lg-12" role="main">

                                                    <div id="show-nomTarificacion" class="content scaffold-show"
                                                         role="main">
                                                        <div class="alert alert-success">
                                                            <strong>¡Correcto!</strong> Nueva Tarificación.
                                                        </div>
                                                        <g:form resource="${this.nomTarificacion}"
                                                                method="DELETE">
                                                            <g:link action="edit" resource="${this.nomTarificacion}">
                                                            ...
                                                            <g:each var="Linea"
                                                                    ...
                                                                    status="j">
                                                                <g:if test="${Objects.equals(nomTarificacion.id, Linea.tarificacion?.id)}">
