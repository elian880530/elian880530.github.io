                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-asignacion" class="col-lg-12" role="main">

                                                    <div id="show-asignacion" class="content scaffold-show"
                                                         role="main">
                                                        <div class="alert alert-success">
                                                            <strong>¡Correcto!</strong> Nueva Asignación.
                                                        </div>
                                                        <g:form resource="${this.asignacion}"
                                                                method="DELETE">
                                                            <g:link action="edit" resource="${this.asignacion}">
