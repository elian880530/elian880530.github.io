            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="NomTipoMicro">
                                    Nueva
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Micros</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main" >
                    <div class="form-inline">
                        <g:uploadForm controller="NomTipoMicro" action="uploadFile" class="form-inline">
                            <ol class="breadcrumb derecha">
                                ...
                                <li>
                                    <g:link action="downloadFile" controller="NomTipoMicro">
                ...
                <div class="col-md-12 content scaffold-show" role="main">
                    <g:if test="${flash.message == "1"}">
                        <div class="alert alert-success">
                            <strong>¡Correcto!</strong> Nuevo Micro Importado desde el Archivo Excel.
                        </div>
                    </g:if>
                                            ...
                                            <div class="table-responsive">
                                                <div id="dataTables-example_wrapper"
                                                    ...
                                                    <table class="table-hover table table-dark table-striped dataTable no-footer"
                                                        ...
                                                        <tbody>
                                                        <g:each in="${nomTipoMicroList}" var="tipoMicro" status="i">
                                                            <tr>
                                                                <td class="sorting_1">${tipoMicro.id}</td>
                                                                <td>${tipoMicro.tipoMicro}</td>
                                                                <td>
                                                                    <a href="/nomTipoMicro/edit/${tipoMicro.id}"
                                                                       class="edit"><i
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <g:each var="Tablet"
                                                                            ...
                                                                            status="j">
                                                                        <g:if test="${Objects.equals(tipoMicro.id, Tablet.tipoMicro?.id)}">
                                                                    ...
                                                                    <g:each var="Movil"
                                                                            ...
                                                                            status="k">
                                                                        <g:if test="${Objects.equals(tipoMicro.id, Movil.tipoMicro?.id)}">
                                                                            <g:set var="utilizado" value="${1}"/>
                                                                        </g:if>
                                                                    </g:each>
                                                                    <g:each var="Pc"
                                                                            ...
                                                                            status="l">
                                                                        <g:if test="${Objects.equals(tipoMicro.id, Pc.tipoMicro?.id)}">
                                                                            <g:set var="utilizado" value="${1}"/>
                                                                        </g:if>
                                                                    </g:each>
                                                                    <g:each var="Portatil"
                                                                            ...
                                                                            status="m">
                                                                        <g:if test="${Objects.equals(tipoMicro.id, Portatil.tipoMicro?.id)}">
                                                                            <g:set var="utilizado" value="${1}"/>
                                                                        </g:if>
                                                                    </g:each>
                                                                    <g:if test="${utilizado == 0}">
                                                                        <button type="button" class="eliminar"
                                                                                data-toggle="modal"
                                                                                data-target="#exampleModal${tipoMicro.id}">
                                                                            <i class="glyphicon glyphicon-trash"></i>
                                                                        </button>
                                                                        <!-- Modal -->
                                                                        <div class="modal fade"
                                                                             id="exampleModal${tipoMicro.id}" tabindex="-1"
                                                                             role="dialog"
                                                                             aria-labelledby="exampleModalLabel${tipoMicro.id}"
                                                                             aria-hidden="true">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="alert alert-warning">
                                                                                            <strong>
                                                                                                ¿Está usted seguro que desea eliminar el tipo de micro con el identificador ${tipoMicro.id}?
                                                                                            </strong>
                                                                                        </div>
                                                                                    </div>

                                                                                    <div class="modal-footer">
                                                                                        <g:form resource="${tipoMicro}"
                                                                                                method="DELETE">
                                                                                            <button type="submit"
