            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="Linea">
                                    Nueva
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Líneas</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main" >
                    <div class="form-inline">
                        <g:uploadForm controller="Linea" action="uploadFile" class="form-inline">
                            <ol class="breadcrumb derecha">
                                ...
                                <li>
                                    <g:link action="downloadFile" controller="Linea">
                ...
                <div class="col-md-12 content scaffold-show" role="main">
                    <g:if test="${flash.message == "1"}">
                        <div class="alert alert-success">
                            <strong>¡Correcto!</strong> Nueva Línea Importada desde el Archivo Excel.
                        </div>
                    </g:if>
                                                    ...
                                                    <table class="table-hover table table-dark table-striped dataTable no-footer"
                                                        ...
                                                        <g:each in="${lineaList}" var="linea" status="i">
                                                            <tr>
                                                                ...
                                                                <td>${linea.numSim}</td>
                                                                <td>${linea.telefonoCorto}</td>
                                                                <td>${linea.telefonoLargo}</td>
                                                                <td>${linea.pin}</td>
                                                                <td>${linea.puk}</td>
                                                                <td>${linea.tarificacion}</td>
                                                                <td>${linea.cuentaFacturacion}</td>
                                                                <td>${linea.ubicacion}</td>
                                                                <td>${linea.lineaAsignada}</td>
                                                                <td>
                                                                    <a href="/linea/edit/${linea.id}" class="edit"><i
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <g:if test="${asignado == 0}">
                                                                        <button type="button" class="eliminar"
                                                                                data-toggle="modal"
                                                                                data-target="#exampleModal${linea.id}">
                                                                            <i class="glyphicon glyphicon-trash"></i>
                                                                        </button>
                                                                        <!-- Modal -->
                                                                        <div class="modal fade"
                                                                             id="exampleModal${linea.id}" tabindex="-1"
                                                                             role="dialog"
                                                                             aria-labelledby="exampleModalLabel${linea.id}"
                                                                             aria-hidden="true">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="alert alert-warning">
                                                                                            <strong>
                                                                                                ¿Está usted seguro que desea eliminar la línea con el identificador ${linea.id}?                                                                                            </strong>
                                                                                        </div>
                                                                                    </div>
