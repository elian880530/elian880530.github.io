            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Nueva <small>Proveedor</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a>
                        </li>
                        <li><a href="#">
                            <g:link action="index" controller="NomProveedor">
                                Listado Proveedores
                            </g:link>
                        </a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-nomProveedor" class="col-lg-12" role="main">

                                                    <div id="show-nomProveedor" class="content scaffold-show"
                                                         role="main">
                                                        <div class="alert alert-success">
                                                            <strong>¡Correcto!</strong> Nuevo Proveedor.
                                                        </div>
                                                        <g:form resource="${this.nomProveedor}"
                                                                method="DELETE">
                                                            <g:link action="edit" resource="${this.nomProveedor}">
                                                            ...
                                                            <g:each var="Dispositivo"
                                                                    ...
                                                                    status="j">
                                                                <g:if test="${Objects.equals(nomProveedor.id, Dispositivo.proveedor?.id)}">
