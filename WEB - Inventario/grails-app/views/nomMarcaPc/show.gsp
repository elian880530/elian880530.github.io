                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-nomMarcaPc" class="col-lg-12" role="main">

                                                    <div id="show-nomMarcaPc" class="content scaffold-show"
                                                         role="main">
                                                        <div class="alert alert-success">
                                                            <strong>¡Correcto!</strong> Nueva Marca Pc.
                                                        </div>
                                                        <g:form resource="${this.nomMarcaPc}"
                                                                method="DELETE">
                                                            <g:link action="edit" resource="${this.nomMarcaPc}">
                                                            ...
                                                            <g:each var="Pc"
                                                                    ...
                                                                    status="j">
                                                                <g:if test="${Objects.equals(nomMarcaPc.id, Pc.marcaPc?.id)}">
