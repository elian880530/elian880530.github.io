                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="edit-pc" class="paginaform" role="main">
                                                    <g:form class="form-inline" role="form" resource="${this.pc}" method="PUT" onsubmit="return validacion()">
                                                        <div class="form-group dataselect">
                                                            <label>Fecha de Compra</label>
                                                            <g:datePicker type="date" name="fechaCompra" precision="day" value="${this.pc?.fechaCompra}"/>
                                                        </div>

                                                        <div class="form-group">
                                                            <label>Marca Pc</label>
                                                            <select class="selectpicker form-control" name="marcaPc.id" id="marcaPc" data-size="5" data-live-search="true">
                                                                <g:set var="valor" value="${this.pc?.marcaPc}"/>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker form-control" name="proveedor.id" id="proveedor" data-size="5" data-live-search="true">
                                                                <g:set var="valor" value="${this.pc?.proveedor}"/>
                                                                <option value="${valor.id}" selected><li>${valor}</li></option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker form-control" name="tipoMicro.id" id="tipoMicro" data-size="5" data-live-search="true">
                                                                <g:set var="valor" value="${this.pc?.tipoMicro}"/>
                                                                <option value="${valor.id}" selected><li>${valor}</li></option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker form-control" name="cantRam.id" id="cantRam" data-size="5" data-live-search="true">
                                                                <g:set var="valor" value="${this.pc?.cantRam}"/>
                                                                <option value="${valor.id}" selected><li>${valor}</li></option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="selectpicker form-control" name="cantAlmacenamiento.id" id="cantAlmacenamiento" data-size="5" data-live-search="true">
                                                                <g:set var="valor" value="${this.pc?.cantAlmacenamiento}"/>
                                                                <option value="${valor.id}" selected><li>${valor}</li></option>
                                                                <g:each var="e"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" value="${this.pc?.pegatina}" required="" maxlength="100" name="pegatina" id="pegatina" type="text">
                                                        </div>

                                                        <div class="form-group">
                                                            <label>Ubicación</label>
                                                            <select class="selectpicker form-control" name="ubicacion.id" id="ubicacion" data-size="5" data-live-search="true">
                                                                <g:set var="valor" value="${this.pc?.ubicacion}"/>
                                                                <option value="${valor.id}" selected><li>${valor}</li></option>
                                                        ...
                                                        <g:render template="/layouts/ImportacionValidarCambiosEditPc"/>

                                                        <div class="form-group">
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input type="checkbox"
                                                                        <g:if test="${Objects.equals(true, pc?.dispositivoAsignado)}">
                                                                            checked="checked"
                                                                        </g:if>
                                                                           disabled="disabled"
