<%@ page import="inventario.AsignacionController;inventario.Persona;inventario.Pc;inventario.Asignacion"%>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <title>Mostrar PC</title>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-pc" class="col-lg-12" role="main">

                                                    <div id="show-pc" class="content scaffold-show"
                                                         role="main">
                                                        <div class="alert alert-success">
                                                            <strong>¡Correcto!</strong> Nuevo PC.
                                                        </div>
                                                        <g:form resource="${this.pc}"
                                                                method="DELETE">
                                                            <g:link action="edit" resource="${this.pc}">
                                                    ...
                                                    <div id="create-asignacion" class="paginaform" role="main">
                                                        <form class="form-inline" role="form" action="/asignacion/savePc" method="post">
                                                            ...
                                                            <div class="form-group elementos-impares">
                                                                ...
                                                                <select resource="${pc}" class="selectpicker form-control" name="pc.id">
                                                                    <option value="${pc.id}"><li>${pc.pegatina}</li></option>
                                                                </select>
                                                            </div>
                                                ...
                                                <g:else>
                                                    <div id="edit-asignacion" class="paginaform" role="main">
                                                        <g:form class="form-inline" role="form" resource="${asignacion}" method="PUT" onsubmit="return validacion()">
                                                            ...
                                                            <g:render template="/layouts/ImportacionValidarCambiosPc"/>
