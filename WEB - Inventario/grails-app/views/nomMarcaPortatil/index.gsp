        ...
        <div id="page-inner">
            ...
            <div class="col-md-12">
                <h1 class="page-header">
                    Listado <small>Marcas Portátiles</small>
                </h1>
            </div>
            <div class="col-md-6">
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="#">
                            <g:link action="create" controller="NomMarcaPortatil">
                                Nueva
                            </g:link>
                        </a>
                    </li>
                    <li class="active">Listado Marcas Portátiles</li>
                </ol>
            </div>
            <div class="col-md-6" id="content" role="main" >
                <div class="form-inline">
                    <g:uploadForm controller="NomMarcaPortatil" action="uploadFile" class="form-inline">
                        <ol class="breadcrumb derecha">
                            ...
                            <li>
                                <g:link action="downloadFile" controller="NomMarcaPortatil">
            ...
            <div class="col-md-12 content scaffold-show" role="main">
                <g:if test="${flash.message == "1"}">
                    <div class="alert alert-success">
                        <strong>¡Correcto!</strong> Nueva Marca de Portátil Importada desde el Archivo Excel.
                    </div>
                </g:if>
                                            ...
                                            <div class="table-responsive">
                                                <div id="dataTables-example_wrapper"
                                                    ...
                                                    <table class="table-hover table table-dark table-striped dataTable no-footer"
                                                        ...
                                                        <tbody>
                                                        <g:each in="${nomMarcaPortatilList}" var="marcaPortatil"
                                                                status="i">
                                                            <tr>
                                                                <td class="sorting_1">${marcaPortatil.id}</td>
                                                                <td>${marcaPortatil.marcaPortatil}</td>
                                                                <td>
                                                                    <a href="/nomMarcaPortatil/edit/${marcaPortatil.id}"
                                                                       class="edit"><i
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <g:each var="Portatil"
                                                                            ...
                                                                            status="j">
                                                                        <g:if test="${Objects.equals(marcaPortatil.id, Portatil.marcaPortatil?.id)}">
                                                                    ...
                                                                    <g:if test="${utilizado == 0}">
                                                                        <button type="button" class="eliminar"
                                                                                data-toggle="modal"
                                                                                data-target="#exampleModal${marcaPortatil.id}">
                                                                            <i class="glyphicon glyphicon-trash"></i>
                                                                        </button>
                                                                        <!-- Modal -->
                                                                        <div class="modal fade"
                                                                             id="exampleModal${marcaPortatil.id}" tabindex="-1"
                                                                             role="dialog"
                                                                             aria-labelledby="exampleModalLabel${marcaPortatil.id}"
                                                                             aria-hidden="true">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        <div class="alert alert-warning">
                                                                                            <strong>
                                                                                                ¿Está usted seguro que desea eliminar la marca de portatil con el identificador ${marcaPortatil.id}?
                                                                                            </strong>
                                                                                        </div>
                                                                                    </div>

                                                                                    <div class="modal-footer">
                                                                                        <g:form resource="${marcaPortatil}"
                                                                                                method="DELETE">
                                                                                            <button type="submit"
