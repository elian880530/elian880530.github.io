                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-nomMarcaPortatil" class="col-lg-6" role="main">
                                                    <form role="form" action="/nomMarcaPortatil/save" method="post">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" value="" required=""
                                                                   maxlength="100"
                                                                   name="marcaPortatil" id="marcaPortatil" type="text">
                                                        </div>
                                                        <g:link action="index" controller="NomMarcaPortatil">
