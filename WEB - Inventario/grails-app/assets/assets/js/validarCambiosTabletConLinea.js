...
var varOriginalTablet = document.getElementById("tabletLineaAsignado").value;
...
var varSelectTablet = document.getElementById("tabletLineaAsignado").value;
...
$(document).ready(function() {
    ...
    $('#tabletLineaAsignado').on('change', function() {
        varSelectTablet = document.getElementById("tabletLineaAsignado").value;
    });
