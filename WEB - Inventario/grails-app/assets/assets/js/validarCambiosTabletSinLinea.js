...
var varOriginalTablet = document.getElementById("tabletNoLineaAsignado").value;
...
var varSelectTablet = document.getElementById("tabletNoLineaAsignado").value;
...
$(document).ready(function() {
    ...
    $('#tabletNoLineaAsignado').on('change', function() {
        varSelectTablet = document.getElementById("tabletNoLineaAsignado").value;
    });
