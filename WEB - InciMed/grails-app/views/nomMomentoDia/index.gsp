            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Listado <small>Momento Día</small>
                    </h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="NomMomentoDia">
                                    Nuevo
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Momento Día</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main">
                    <div class="form-inline">
                        <ol class="breadcrumb derecha">
                            ...
                            <li>
                                <g:link action="downloadFile" controller="NomMomentoDia">
...
<script src="/assets/js/tablaDinamicaBuscadorMomentoDia.js"></script>
</body>
</html>
