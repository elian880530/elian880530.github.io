...
<head>
    ...
    <title>Mostrar Incidencia Medicación</title>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-incidenciaMedicacion" class="col-lg-12" role="main">
                                                    <div id="show-incidenciaMedicacion" class="content scaffold-show"
                                                         role="main">
                                                        <div class="alert alert-success">
                                                            <strong>¡Correcto!</strong> Nueva Incidencia Medicación.
                                                        </div>
                                                        <g:form resource="${this.incidenciaMedicacion}" method="DELETE">
                                                            <g:link action="edit"
                                                                    resource="${this.incidenciaMedicacion}">
