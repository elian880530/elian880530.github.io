            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Listado <small>Tipo Error</small>
                    </h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="TipoError">
                                    Nuevo
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Tipo Error</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main">
                    <div class="form-inline">
                        <ol class="breadcrumb derecha">
                            ...
                            <li>
                                <g:link action="downloadFile" controller="TipoError">
...
<script src="/assets/js/tablaDinamicaBuscadorTipoError.js"></script>
</body>
</html>
