...
<head>
    ...
    <title>Mostrar Tipo Error</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Nuevo <small>Tipo Error</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a>
                        </li>
                        <li><a href="#">
                            <g:link action="index" controller="TipoError">
                                Listado Tipos Error
                            </g:link>
                        </a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-tipoError" class="col-lg-12" role="main">
                                                    <div id="show-tipoError" class="content scaffold-show"
                                                         role="main">
                                                        <div class="alert alert-success">
                                                            <strong>¡Correcto!</strong> Nuevo Tipo Error.
                                                        </div>
                                                        <g:form resource="${this.tipoError}" method="DELETE">
                                                            <g:link action="edit" resource="${this.tipoError}">
                                                            ...
                                                            <g:each var="listInci"
                                                                ...
                                                                <g:set var="listaUsadas"
                                                                       value="${listaUsadas + listInci.tipoError}"/>
                                                            </g:each>
                                                            <g:each var="resultado" in="${listaUsadas}">
                                                                <g:if test="${resultado.equals(this.tipoError)}">
