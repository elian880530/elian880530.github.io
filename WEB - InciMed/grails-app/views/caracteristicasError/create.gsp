                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-caracteristicasError" class="col-lg-6" role="main">
                                                    <form role="form" action="/caracteristicasError/save" method="post">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" value="" required=""
                                                                   maxlength="100"
                                                                   name="caracteristicasError" id="caracteristicasError"
                                                                   type="text">
                                                        </div>
                                                        <g:link action="index" controller="CaracteristicasError">
