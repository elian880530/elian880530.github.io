...
<head>
    ...
    <title>Características Error</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Listado <small>Características Error</small>
                    </h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="CaracteristicasError">
                                    Nuevo
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Características Error</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main">
                    <div class="form-inline">
                        <ol class="breadcrumb derecha">
                            ...
                            <li>
                                <g:link action="downloadFile" controller="CaracteristicasError">
...
<script src="/assets/js/tablaDinamicaBuscadorCaracteristicasError.js"></script>
</body>
</html>
