...
<head>
    ...
    <title>Mostrar Gravedad Error</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Nueva <small>Gravedad Error</small>
                    </h1>
                    <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="create-nomGravedadError" class="col-lg-12" role="main">
                                                    <div id="show-nomGravedadError" class="content scaffold-show"
                                                         role="main">
                                                        <div class="alert alert-success">
                                                            <strong>¡Correcto!</strong> Nueva Gravedad Error.
                                                        </div>
                                                        <g:form resource="${this.nomGravedadError}" method="DELETE">
                                                            <g:link action="edit" resource="${this.nomGravedadError}">
                                                            ...
                                                            <g:each var="listInci"
                                                                ...
                                                                <g:set var="listaUsadas"
                                                                       value="${listaUsadas + listInci.gravedadError}"/>
                                                            </g:each>
                                                            <g:each var="resultado" in="${listaUsadas}">
                                                                <g:if test="${resultado.equals(this.nomGravedadError)}">
