            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Listado <small>Causas Error</small>
                    </h1>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="#">
                                <g:link action="create" controller="CausasError">
                                    Nuevo
                                </g:link>
                            </a>
                        </li>
                        <li class="active">Listado Causas Error</li>
                    </ol>
                </div>
                <div class="col-md-6" id="content" role="main">
                    <div class="form-inline">
                        <ol class="breadcrumb derecha">
                            ...
                            <li>
                                <g:link action="downloadFile" controller="CausasError">
...
<script src="/assets/js/tablaDinamicaBuscadorCausasError.js"></script>
</body>
</html>
