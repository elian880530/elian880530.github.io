...
<head>
    ...
    <title>Editar Causas Error</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Editar <small>Causas Error</small>
                    </h1>
                    <ol class="breadcrumb">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div id="edit-causasError" class="paginaform" role="main">
                                                    <g:form class="form-inline" role="form"
                                                            resource="${this.causasError}" method="PUT"
                                                            onsubmit="return validacion()">
                                                        <div class="form-group">
                                                            <label>
                                                                Valor
                                                            </label>
                                                            <input class="form-control" value="${this.causasError}"
                                                                   required=""
                                                                   maxlength="100" name="causasError" id="causasError"
                                                                   type="text">
                                                        </div>
                                                        <g:render template="/layouts/ImportacionModalAlerta"/>
                                                        <g:render
                                                                template="/layouts/ImportacionValidarCambiosEditCausasError"/>
                                                        <div id="paginaform">
